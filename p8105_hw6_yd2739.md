...
```
    ...
    ## Warning: Removed 3399 rows containing non-finite values (`stat_density()`).
...
the coefficient. The 2.5% quantile of coefficient product’s log is
-0.009531940, the 97.5% quantile of coefficient product’s log is
0.007972366.
...
still slightly left skewed. The 2.5% quantile of coefficient product’s
log is 0.8889543, the 97.5% quantile of coefficient product’s log is
0.9407838.
...
![](p8105_hw6_yd2739_files/figure-gfm/unnamed-chunk-18-1.png)<!-- -->
