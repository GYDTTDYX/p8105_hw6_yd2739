...
```
We could see that the coefficient product's log result is left skewed. There are also lots of Na in the dataset caused by negative product of the coefficient. The 2.5% quantile of coefficient product's log is -8.801647, the 97.5% quantile of coefficient product's log is -4.588863.
```{r}
p2_result|>
